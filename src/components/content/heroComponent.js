...
export function HeroComponent({Gambar1}) {
  return (
    <div id="hero" className=" flex justify-center items-center w-full h-[416px] lg:h-[760px] lg:pt-20">
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start justify-center h-[80%] w-[90%] gap-2 lg:gap-10 pt-5 lg:pt-0 ">
        <div className=" bg-gradient-to-br from-[#8AAAE5] bg-opacity-0 w-[45%] h-[85%]  lg:w-[400px] lg:h-[400px] rounded-full ">
